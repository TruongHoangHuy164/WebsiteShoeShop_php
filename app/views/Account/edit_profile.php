...
<h1 class="mb-4 text-center" style="color: #ff6b81;">Chỉnh sửa thông tin cá nhân</h1>
...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card p-4" style="border-radius: 15px; background: #fff; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
            ...
            <form method="POST" action="/WebBanHang/account/editProfile" enctype="multipart/form-data">
                <div class="mb-3">
